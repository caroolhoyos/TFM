...
def resolver_partido(texto: str) -> str:
    ...
    if not coincidencias:
        ...
        raise argparse.ArgumentTypeError(f"Partido desconocido o no nacional: {texto!r}. Opciones: {disponibles}")
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Busca una regla de puntuación que haga ganador a un partido nacional usando P7 (perfil reducido a partidos nacionales).")
